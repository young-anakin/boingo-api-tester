...
app = FastAPI(title="Boingo API Wrapper")
...
# Configuration
BOINGO_API_URL = os.getenv("BOINGO_API_URL")
BOINGO_EMAIL = os.getenv("BOINGO_EMAIL")
BOINGO_PASSWORD = os.getenv("BOINGO_PASSWORD")
...
@app.get("/scraping-target/{target_id}")
...
@app.post("/scraping-target/pause")
...
@app.post("/scraping-target/unpause")
...
@app.get("/scraping-results/{result_id}")
